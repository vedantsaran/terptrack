...
const MAJOR_TEMPLATES = {
  ...
  ENME: {
    ...
    coreCodes: [
      'ENES100','ENES102','ENES220','ENES221','ENES232',
      'ENME202','ENME272','ENME331','ENME332','ENME350','ENME351',
      'ENME361','ENME371','ENME382','ENME392','ENME462','ENME472',
    ],
    upperElectiveCodes: ['ENME416','ENME441','ENME466','ENME470','ENME489'],
  ...
  ENEE: {
    ...
    totalCredits: 122,
    fixedSchedule: typeof SCHEDULE_ENEE !== 'undefined' ? SCHEDULE_ENEE : null,
    coreCodes: [
      'ENEE101','ENEE140','ENEE150','ENEE290','ENEE244','ENEE205','ENEE222','ENEE245',
      'ENEE304','ENEE323','ENEE350','ENEE200','ENEE305','ENEE324','ENEE382',
    ],
    upperElectiveCodes: ['ENEE436','ENEE411','ENEE445','ENEE475','ENEE408A','ENEE420','ENEE459B','ENEE486'],
    supportCodes: ['CHEM135','ENES100','MATH140','MATH141','MATH241','PHYS161','PHYS260','PHYS261','PHYS270','PHYS271','STAT400'],
    goals: ['ENEE408A','ENEE436'],
    notes: 'EE BS. Curated current-catalog path with programming, circuits, signals, micro/nanoelectronics, electromagnetics, and categorized EE electives.',
  },
  ENAE: {
    id: 'ENAE', college: 'ENG',
    ...
    totalCredits: 124,
    fixedSchedule: typeof SCHEDULE_ENAE !== 'undefined' ? SCHEDULE_ENAE : null,
    coreCodes: [
      'ENAE100','ENAE202','ENAE203','ENAE222','ENAE283','ENAE284','ENAE301','ENAE310','ENAE362','ENAE380',
      'ENAE325','ENAE364','ENAE410','ENAE432','ENAE423','ENAE480','ENAE403','ENAE491','ENAE455','ENAE492',
    ],
    upperElectiveCodes: ['ENAE425','ENAE471'],
    supportCodes: ['ENES100','ENES200','ENES232','CHEM135','MATH140','MATH141','MATH241','MATH243','PHYS161','PHYS260','PHYS261','PHYS270','PHYS271'],
    goals: ['ENAE492'],
    notes: 'Aerospace BS. Curated current-catalog aeronautical track with CAD, mechanics, aerodynamics, controls, propulsion, and senior aircraft design.',
  },
  ENCE: {
    id: 'ENCE', college: 'ENG',
    ...
    totalCredits: 122,
    fixedSchedule: typeof SCHEDULE_ENCE !== 'undefined' ? SCHEDULE_ENCE : null,
    coreCodes: [
      'ENES100','ENES102','ENES200','ENES220',
      'ENCE202','ENCE305','ENCE203','ENCE303','ENCE312','ENCE365','ENCE336','ENCE340','ENCE383',
      'ENCE367','ENCE436','ENCE342','ENCE483','ENCE442','ENCE464','ENCE467',
    ],
    upperElectiveCodes: ['ENCE420','ENCE472','ENCE466','STAT400'],
    supportCodes: ['CHEM135','GEOL120','MATH140','MATH141','MATH241','MATH243','PHYS161','PHYS260','PHYS261'],
    goals: ['ENCE467'],
    notes: 'Civil Engineering BS. Curated current-catalog path through graphics, computing, materials, systems, geotech, transportation, environmental, and capstone design.',
  },
  BIOE: {
    id: 'BIOE', college: 'ENG',
    name: 'Bioengineering',
    ...
    totalCredits: 126,
    fixedSchedule: typeof SCHEDULE_BIOE !== 'undefined' ? SCHEDULE_BIOE : null,
    coreCodes: [
      'ENES100','BIOE120','BIOE121','BIOE241','BIOE221','BIOE232','BIOE246','BIOE331','BIOE372','BIOE340','BIOE457','BIOE485','BIOE486',
    ],
    upperElectiveCodes: ['BIOE404','BIOE411','BIOE420','BIOE453','BIOE489A','BIOE489B'],
    supportCodes: ['CHEM135','CHEM136','CHEM231','CHEM232','ENES102','ENES200','MATH140','MATH141','MATH241','MATH243','PHYS161','PHYS260','PHYS261','BSCI207','BSCI331','BSCI332','BSCI430'],
    goals: ['BIOE485','BIOE486'],
    notes: 'BIOE BS. Curated current-catalog path with engineering biology, thermodynamics, biofluids, biostatistics, physiology, instrumentation, electives, and capstone.',
  },
  ...
  MATH: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_MATH !== 'undefined' ? SCHEDULE_MATH : null,
    coreCodes: [
      'MATH140','MATH141','MATH240','MATH241','MATH246','MATH310',
      'MATH403','MATH405','MATH410','MATH411','MATH430','MATH452','MATH456','STAT410',
    ],
    upperElectiveCodes: ['MATH403','MATH430','MATH452','MATH456'],
    supportCodes: ['CMSC131','CMSC132','CMSC216'],
    goals: ['MATH411'],
    notes: 'Mathematics BS traditional track. Curated current-catalog plan with proof, differential equations, eight 400-level MATH/STAT courses, depth sequence, and CMSC support.',
  },
  STAT: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_STAT !== 'undefined' ? SCHEDULE_STAT : null,
    coreCodes: [
      'MATH140','MATH141','MATH240','MATH241','MATH246','MATH310','MATH405','MATH410',
      'STAT400','STAT401','STAT410','STAT420','STAT426','STAT430','STAT440','AMSC460',
    ],
    upperElectiveCodes: ['STAT426','STAT440'],
    supportCodes: ['CMSC131','CMSC132'],
    goals: ['STAT420'],
    notes: 'Statistics track in the Mathematics BS. Curated current-catalog plan with proof, computational methods, statistical computing, probability, methods, programming, and STAT electives.',
  },
  CHEM: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_CHEM !== 'undefined' ? SCHEDULE_CHEM : null,
    coreCodes: [
      'CHEM146','CHEM177','CHEM237','CHEM247','CHEM276','CHEM277',
      'CHEM395','CHEM425','CHEM481','CHEM483','CHEM401','CHEM482','CHEM484',
    ],
    upperElectiveCodes: ['CHEM441','BCHM461'],
    supportCodes: ['BSCI170','BSCI171','MATH140','MATH141','MATH241','PHYS161','PHYS260','PHYS261'],
    goals: ['CHEM441'],
    notes: 'Chemistry BS. Curated current-catalog chemistry-major path with CHEM 146/177, 237, 247, 276/277, physical chemistry labs, inorganic chemistry, and approved upper CHEM/BCHM electives.',
  },
  PHYS: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_PHYS !== 'undefined' ? SCHEDULE_PHYS : null,
    coreCodes: [
      'PHYS170','PHYS171','PHYS265','PHYS272','PHYS273','PHYS275','PHYS276',
      'PHYS313','PHYS371','PHYS375','PHYS401','PHYS402','PHYS404','PHYS405','PHYS410','PHYS413',
    ],
    upperElectiveCodes: ['PHYS420','PHYS441'],
    supportCodes: ['MATH140','MATH141','MATH241','MATH243'],
    goals: ['PHYS402'],
    notes: 'Physics BS, Physics specialization. Curated current-catalog plan with professional seminar, introductory physics sequence, scientific programming, experiments, quantum, E&M, statistical thermodynamics, mechanics, and advanced electives.',
  },
  ASTR: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_ASTR !== 'undefined' ? SCHEDULE_ASTR : null,
    coreCodes: [
      'ASTR130','ASTR131','ASTR232','ASTR310','ASTR320','ASTR406','ASTR415','ASTR421','ASTR450','ASTR498N',
      'PHYS313','PHYS371','PHYS401','PHYS410',
    ],
    upperElectiveCodes: ['ASTR410','ASTR422','ASTR430','ASTR435','ASTR480','PHYS404'],
    supportCodes: ['PHYS171','PHYS265','PHYS272','PHYS273','PHYS275','PHYS276','MATH140','MATH141','MATH241','MATH243'],
    goals: ['ASTR498N'],
    notes: 'Astronomy BS, Astrophysics specialization. Curated current-catalog plan with the new ASTR 130/131/232 sequence, observational/theoretical astrophysics, advanced ASTR electives, PHYS 313/371/401/410, and research credit.',
  },
  ...
  FINANCE: {
    ...
    coreCodes: [
      'BMGT110','BMGT220','BMGT221','BMGT230','BMGT301','BMGT340','BMGT350','BMGT364','BMGT367','BMGT380','BMGT495',
      'BMGT343','BMGT440','BMGT347','BMGT441','BMGT443','BMGT446','BMGT332','BMGT341','BMGT445',
    ],
    upperElectiveCodes: ['BMGT442','BMGT444','BMGT349','BMGT448','BMGT449'],
    supportCodes: ['ECON200','ECON201','MATH220'],
    goals: ['BMGT443','BMGT495'],
    notes: 'Smith Business — Finance. Current Smith common core plus investments, advanced finance, quantitative finance, financial markets, and upper-level finance electives.',
  },
  MARKETING: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_MARKETING !== 'undefined' ? SCHEDULE_MARKETING : null,
    coreCodes: [
      'BMGT110','BMGT220','BMGT221','BMGT230','BMGT301','BMGT340','BMGT350','BMGT364','BMGT367','BMGT380','BMGT495',
      'BMGT354','BMGT351','BMGT457','BMGT456','BMGT453','BMGT450','BMGT454','BMGT455',
    ],
    upperElectiveCodes: ['BMGT458','BMGT484'],
    supportCodes: ['ECON200','ECON201','MATH220'],
    goals: ['BMGT495'],
    notes: 'Smith Business — Marketing. Fixed plan follows the current catalog: consumer analysis, marketing research, marketing policy capstone, and current marketing electives.',
  },
  ACCOUNTING: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_ACCOUNTING !== 'undefined' ? SCHEDULE_ACCOUNTING : null,
    coreCodes: [
      'BMGT110','BMGT220','BMGT221','BMGT230','BMGT301','BMGT340','BMGT350','BMGT364','BMGT367','BMGT380','BMGT495',
      'BMGT310','BMGT321','BMGT326','BMGT311','BMGT323','BMGT411','BMGT422','BMGT417',
    ],
    upperElectiveCodes: ['BMGT313','BMGT410','BMGT423','BMGT424'],
    supportCodes: ['ECON200','ECON201','MATH220'],
    goals: ['BMGT417','BMGT495'],
    notes: 'Smith Business — Accounting, public accounting path. Current catalog plan includes intermediate accounting, managerial accounting, systems, audit, ethics, and tax.',
  },
  IS: {
    id: 'IS', college: 'BMGT',
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_IS !== 'undefined' ? SCHEDULE_IS : null,
    coreCodes: [
      'BMGT110','BMGT220','BMGT221','BMGT230','BMGT301','BMGT340','BMGT350','BMGT364','BMGT367','BMGT380','BMGT495',
      'BMGT302','BMGT402','BMGT403','BMGT407','BMGT400','BMGT401','BMGT430','BMGT485',
    ],
    upperElectiveCodes: ['BMGT404','BMGT406','BMGT476','BMGT326'],
    supportCodes: ['ECON200','ECON201','MATH220'],
    goals: ['BMGT495'],
    notes: 'Smith Business — Information Systems. Current catalog plan includes programming/AI skills, database systems, systems analysis, IS projects, analytics, and project management.',
  },
  ...
  PSYC: {
    ...
    coreCodes: [
      'PSYC100','PSYC200','PSYC300','PSYC304','PSYC334','PSYC341','PSYC353','PSYC355','PSYC489',
    ],
    upperElectiveCodes: ['PSYC425','PSYC426','PSYC431','PSYC436','PSYC437','PSYC447'],
    supportCodes: ['BSCI170','BSCI171','STAT100','MATH130'],
    goals: ['PSYC489'],
  ...
  COMM: {
    ...
    coreCodes: [
      'COMM107','COMM200','COMM230','COMM250','COMM330','COMM350','COMM402','COMM488',
    ],
    upperElectiveCodes: ['COMM424','COMM453','COMM498'],
    supportCodes: ['STAT100'],
    goals: ['COMM488'],
  ...
  ARCH: {
    ...
    name: 'Architecture',
    programName: 'Architecture - BS option',
    eyebrow: 'UMD · Architecture · BS',
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_ARCH !== 'undefined' ? SCHEDULE_ARCH : null,
    coreCodes: [
      'ARCH171','ARCH225','ARCH200','ARCH226','ARCH300','ARCH201','ARCH462','ARCH400','ARCH463',
      'ARCH401','ARCH402','ARCH403','ARCH464','ARCH465','ARCH466','ARCH472',
    ],
    upperElectiveCodes: ['ARCH408','ARCH430','ARCH460'],
    supportCodes: ['MATH120','PHYS121'],
    goals: ['ARCH403'],
    notes: 'Architecture BS option. Curated current-catalog path with design media, history, ARCH 400-403 studio sequence, systems/structures, professional practice, and studio electives.',
  },
  ...
  ENMA: {
    ...
    totalCredits: 124,
    fixedSchedule: typeof SCHEDULE_ENMA !== 'undefined' ? SCHEDULE_ENMA : null,
    coreCodes: [
      'ENES100','ENMA165','ENMA180','ENMA300','ENMA301','ENMA312','ENMA441','ENMA460','ENMA461','ENMA465','ENMA470','ENMA471','ENMA487','ENMA490',
    ],
    upperElectiveCodes: ['ENMA425','ENMA430','ENMA482'],
    supportCodes: ['CHEM135','CHEM136','CHEM231','CHEM232','CHEM481','ENES200','MATH140','MATH141','MATH241','MATH246','PHYS161','PHYS260','PHYS261','PHYS270','PHYS271'],
    goals: ['ENMA490'],
    notes: 'BS MSE. Curated current-catalog path with programming, characterization, thermodynamics, processing, design, and biomaterials/nanoscale electives.',
  },
  ENFP: {
    id: 'ENFP', college: 'ENG',
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_ENFP !== 'undefined' ? SCHEDULE_ENFP : null,
    coreCodes: [
      'ENFP201','ENFP250','ENFP300','ENFP310','ENFP312','ENFP350','ENFP405','ENFP410','ENFP411','ENFP413','ENFP415','ENFP420','ENFP425','ENFP426','ENFP440',
    ],
    upperElectiveCodes: ['STAT400','ENFP461','ENFP489I','ENME400'],
    supportCodes: ['CHEM135','MATH140','MATH141','MATH241','MATH246','PHYS161','PHYS260','PHYS261','ENES100','ENES102','ENES220','ENES221','ENES232'],
    goals: ['ENFP440'],
    notes: 'Only ABET-accredited FPE BS in the country. Curated path follows the current 120-credit fire safety, suppression, dynamics, modeling, and lab sequence.',
  },
  ...
  BCHM: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_BCHM !== 'undefined' ? SCHEDULE_BCHM : null,
    coreCodes: [
      'CHEM146','CHEM177','CHEM237','CHEM247','CHEM276','CHEM277','CHEM395','CHEM425','CHEM481','CHEM483',
      'BCHM461','BCHM462','BCHM464','BCHM465','BCHM485',
    ],
    upperElectiveCodes: ['BSCI222','BSCI410'],
    supportCodes: ['BSCI170','BSCI171','MATH140','MATH141','MATH241','PHYS161','PHYS260','PHYS261'],
    goals: ['BCHM465'],
    notes: 'Biochemistry BS. Curated current-catalog plan with CHEM 146/177, organic and analytical chemistry, physical chemistry, BCHM 461/462/464/465/485, and approved biology coursework.',
  },
  NEUR: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_NEUR !== 'undefined' ? SCHEDULE_NEUR : null,
    coreCodes: [
      'NEUR200','NEUR305','NEUR306','NEUR405',
    ],
    upperElectiveCodes: ['BCHM461','BSCI222','BSCI331','BSCI332','BSCI410','BSCI440','NEUR479'],
    supportCodes: [
      'MATH135','MATH136','STAT400','BSCI160','BSCI161','BSCI170','BSCI171','CHEM131','CHEM132','CHEM231','CHEM232',
      'CHEM241','CHEM242','CHEM271','CHEM272','PHYS131','PHYS132','PSYC100',
    ],
    goals: ['NEUR405','NEUR479'],
    notes: 'Neuroscience BS, Molecular/Cellular/Physiology track. Curated current-catalog plan with NEUR 200/305/306/405, life-science math, chemistry, physics, psychology, and upper biology/neuroscience choices.',
  },
  AOSC: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_AOSC !== 'undefined' ? SCHEDULE_AOSC : null,
    coreCodes: [
      'AOSC200','AOSC201','AOSC358L','AOSC431','AOSC432','AOSC493','AOSC494','AOSC498',
    ],
    upperElectiveCodes: ['AOSC400','AOSC401','AOSC424','AOSC433','AOSC445','AOSC470'],
    supportCodes: ['CHEM135','CHEM136','MATH140','MATH141','MATH241','MATH246','PHYS161','PHYS174','PHYS260','PHYS261','PHYS270','PHYS271'],
    goals: ['AOSC493','AOSC498'],
    notes: 'Atmospheric and Oceanic Science BS. Curated current-catalog plan with AOSC 200/201/358, dynamics/thermodynamics, senior research, advanced atmosphere/ocean electives, and full math/physics/chemistry support.',
  },
  GEOL: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_GEOL !== 'undefined' ? SCHEDULE_GEOL : null,
    coreCodes: [
      'GEOL100','GEOL110','GEOL102','GEOL322','GEOL341','GEOL342','GEOL423','GEOL443','GEOL393','GEOL394','GEOL490',
    ],
    upperElectiveCodes: ['GEOL351','GEOL340','GEOL446','GEOL444','GEOL331','GEOL412'],
    supportCodes: ['CHEM131','CHEM132','MATH140','MATH141','PHYS161','PHYS261'],
    goals: ['GEOL394','GEOL490'],
    notes: 'Geology BS, Professional track. Curated current-catalog plan with mineralogy, structure, sedimentation, petrology, thesis, field camp, and professional geoscience options.',
  },
  GEOG: {
  ...
  MGMT: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_MGMT !== 'undefined' ? SCHEDULE_MGMT : null,
    coreCodes: [
      'BMGT110','BMGT220','BMGT221','BMGT230','BMGT301','BMGT340','BMGT350','BMGT364','BMGT367','BMGT380','BMGT495',
      'BMGT363','BMGT362','BMGT360','BMGT366','BMGT461','BMGT463','BMGT466',
    ],
    upperElectiveCodes: ['BMGT468','BMGT469'],
    supportCodes: ['ECON200','ECON201','MATH220'],
    goals: ['BMGT495'],
    notes: 'Smith Business — Management. Fixed plan follows the current catalog with leadership, negotiation, human capital, entrepreneurship, cross-cultural, and global strategy courses.',
  },
  SCM: {
    id: 'SCM', college: 'BMGT',
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_SCM !== 'undefined' ? SCHEDULE_SCM : null,
    coreCodes: [
      'BMGT110','BMGT220','BMGT221','BMGT230','BMGT301','BMGT340','BMGT350','BMGT364','BMGT367','BMGT380','BMGT495',
      'BMGT370','BMGT372','BMGT472','BMGT476','BMGT477','BMGT385','BMGT475',
    ],
    upperElectiveCodes: ['BMGT373','BMGT374','BMGT478','BMGT332'],
    supportCodes: ['ECON200','ECON201','MATH220'],
    goals: ['BMGT475','BMGT495'],
    notes: 'Smith Business — Supply Chain Management. Current catalog plan includes logistics, transportation, purchasing, technology applications, international SCM, operations, and network design.',
  },
  ...
  AAST: {
    ...
    programName: 'African American and Africana Studies',
    eyebrow: 'UMD · African American and Africana Studies · BA',
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_AAST !== 'undefined' ? SCHEDULE_AAST : null,
    coreCodes: [
      'AAAS100','AAAS202','AAAS211','AAAS301','AAAS400','AAAS402','AAAS411',
    ],
    upperElectiveCodes: ['AAAS320','AAAS443'],
    supportCodes: ['HIST200','SOCY100'],
    goals: ['AAAS402'],
    notes: 'BA African American and Africana Studies. Interdisciplinary across history, sociology, literature, and policy.',
  },
  ...
  EDUC: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_EDUC !== 'undefined' ? SCHEDULE_EDUC : null,
    coreCodes: [
      'MATH212','MATH213','MATH214','TLPL251','HIST200','GEOG100','TLPL340','SOCY230','TLPL250','EDHD411',
      'EDSP401','TLPL332','TLPL341','TLPL342','TLPL361','TLPL362','TLPL300','TLPL312','TLPL321','TLPL343','TLPL344','TLPL446',
    ],
    upperElectiveCodes: ['TLPL478B','TLPL479B','TLPL478C','TLPL478D','TLPL489A','TLPL489B'],
    supportCodes: ['BSCI170','BSCI171','PHYS121'],
    goals: ['TLPL489A','TLPL489B'],
    notes: 'Elementary Education BS. Curated current-catalog TLPL/EDSP sequence with gateway math/science, professional blocks, internship year, and six student-selected area-of-emphasis slots.',
  },
  ...
  ANSC: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_ANSC !== 'undefined' ? SCHEDULE_ANSC : null,
    coreCodes: [
      'ANSC101','ANSC103','ANSC201','ANSC314','ANSC315','ANSC327','ANSC401','ANSC446','ANSC447','ANSC359',
    ],
    upperElectiveCodes: ['ANSC250','ANSC260','ANSC282','ANSC410','ANSC417','ANSC453'],
    supportCodes: ['BSCI160','BSCI161','BSCI170','BSCI171','BSCI223','CHEM131','CHEM132','CHEM231','AREC250','AREC306','BIOM301','MATH113','STAT100'],
    goals: ['ANSC453'],
    notes: 'BS Animal Sciences. Curated default follows the Animal Care & Management path; pre-vet and species tracks swap upper electives.',
  },
  ENST: {
  ...
  AREC: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_AREC !== 'undefined' ? SCHEDULE_AREC : null,
    coreCodes: [
      'ECON200','ECON201','AREC326','AREC380','AREC422','AREC453','AREC456','AREC481',
    ],
    upperElectiveCodes: ['AREC380','AREC422','AREC453','AREC456','AREC481'],
    supportCodes: ['MATH120','STAT100','BMGT230','GEOG201','GVPT273','ENST415'],
    goals: ['AREC481'],
    notes: 'BS AREC. Curated default emphasizes environmental/resource economics with applied statistics, policy, and energy coursework.',
  },
  PLSC: {
    ...
    totalCredits: 120,
    fixedSchedule: typeof SCHEDULE_PLSC !== 'undefined' ? SCHEDULE_PLSC : null,
    coreCodes: [
      'PLSC110','PLSC111','ENST200','PLSC201','PLSC205','PLSC389','PLSC401','PLSC402','PLSC420','PLSC453',
    ],
    upperElectiveCodes: ['PLSC401','PLSC402','PLSC453'],
    supportCodes: ['BSCI160','BSCI161','BSCI170','BSCI171','BSCI337','AGST275','PHYS121','INAG215','INAG235','MATH115','STAT100'],
    goals: ['PLSC402'],
    notes: 'BS Plant Sciences. Curated default follows a turf and plant systems path; horticulture, urban forestry, and plant biology swap later requirements.',
  },
};
