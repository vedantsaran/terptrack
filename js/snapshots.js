...
function _snapshotPayload() {
  return {
    ...
    scheduleOutputOptions: JSON.parse(JSON.stringify(state.scheduleOutputOptions || { preferences: true, warnings: true, unscheduled: true, recentChanges: true })),
...
function loadSnapshot(id) {
  ...
  Object.assign(state, {
    ...
    scheduleOutputOptions: { preferences: true, warnings: true, unscheduled: true, recentChanges: true, ...(snap.payload.scheduleOutputOptions || {}) },
