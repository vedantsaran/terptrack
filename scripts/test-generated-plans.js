...
async function testCuratedScheduleFixtures(context) {
  const fixtures = [
    ...
    {
      id: 'HIST',
      required: ['HIST200', 'HIST201', 'HIST208B', 'HIST205', 'HIST407', 'HIST408B', 'HIST319L', 'HIST405', 'HIST429F', 'HIST462'],
      goal: 'HIST408B',
      minRealCourses: 15,
    },
    {
      id: 'SOCY',
      required: ['SOCY100', 'SOCY105', 'SOCY201', 'SOCY202', 'SOCY441', 'SOCY498C', 'SOCY410', 'SOCY424', 'SOCY428', 'SOCY465', 'STAT100'],
      goal: 'SOCY498C',
      minRealCourses: 15,
    },
    {
      id: 'SPAN',
      required: ['SPAN203', 'SPAN204', 'SPAN301', 'SPAN303', 'SPAN325', 'SPAN401', 'SPAN408K', 'SPAN363', 'SPAN450', 'SPAN470', 'ENGL101'],
      goal: 'SPAN408K',
      minRealCourses: 15,
    },
    {
      id: 'PHIL',
      required: ['PHIL170', 'PHIL250', 'PHIL310', 'PHIL320', 'PHIL332', 'PHIL370', 'PHIL408R', 'PHIL360', 'PHIL428A', 'PHIL445', 'PHIL443'],
      goal: 'PHIL408R',
      minRealCourses: 15,
    },
    {
      id: 'ARTH',
      required: ['ARTH221', 'ARTH200', 'ARTH201', 'ARTH250', 'ARTH320', 'ARTH488K', 'ARTH489K', 'ARTH351', 'ARTH418', 'ARTH465'],
      goal: 'ARTH489K',
      minRealCourses: 15,
    },
    {
      id: 'LING',
      required: ['LING200', 'LING240', 'LING311', 'LING321', 'LING322', 'LING330', 'LING420', 'LING444', 'LING410', 'LING419B', 'LING440', 'PHIL170', 'STAT100'],
      goal: 'LING444',
      minRealCourses: 17,
    },
    {
    ...
    {
      id: 'WMST',
      required: ['WMST200', 'WMST250', 'WMST300', 'WMST488B', 'WMST498Q', 'WMST314', 'WMST452', 'WMST471', 'SOCY100', 'PSYC100', 'ENGL101', 'STAT100'],
      goal: 'WMST498Q',
      minRealCourses: 15,
    },
    {
      id: 'AMST',
      required: ['AMST202', 'AMST205', 'AMST260', 'AMST340', 'AMST450', 'AMST498A', 'AMST328C', 'AMST398', 'AMST428P', 'ENGL101', 'HIST200', 'STAT100'],
      goal: 'AMST498A',
      minRealCourses: 15,
    },
    {
    ...
    {
      id: 'ANTH',
      required: ['ANTH222', 'ANTH240', 'ANTH260', 'ANTH305', 'ANTH411', 'ANTH498Y', 'ANTH415', 'ANTH447', 'ANTH462', 'STAT100'],
      goal: 'ANTH498Y',
      minRealCourses: 14,
    },
    {
      id: 'FMSC',
      required: ['FMSC170', 'FMSC110', 'FMSC260', 'FMSC290', 'FMSC330', 'FMSC332', 'FMSC381', 'FMSC487', 'FMSC498', 'FMSC430', 'FMSC450', 'PSYC100', 'STAT100'],
      goal: 'FMSC498',
      minRealCourses: 16,
    },
    {
      id: 'GEOG',
      required: ['GEOG201', 'GEOG202', 'GEOG211', 'GEOG212', 'GEOG301', 'GEOG306', 'GEOG372', 'GEOG470', 'GEOG498I', 'GEOG373', 'GEOG423', 'GEOG432', 'STAT100', 'MATH130'],
      goal: 'GEOG498I',
      minRealCourses: 17,
    },
    {
      id: 'HESP',
      required: ['HESP120', 'HESP202', 'HESP300', 'HESP311', 'HESP400', 'HESP402', 'HESP411', 'HESP420', 'HESP489', 'HESP406', 'HESP417', 'HESP422', 'PSYC100', 'BSCI201', 'STAT100', 'LING200'],
      goal: 'HESP489',
      minRealCourses: 19,
    },
    {
      id: 'KNES',
      required: ['KNES157T', 'KNES287', 'KNES289', 'KNES293', 'KNES350', 'KNES360', 'KNES385', 'KNES450', 'KNES400', 'KNES440', 'KNES465', 'BSCI201', 'BSCI202', 'CHEM131', 'MATH130', 'STAT100'],
      goal: 'KNES450',
      minRealCourses: 19,
    },
    {
      id: 'PHSC',
      required: ['SPHL100', 'PHSC300', 'EPIB301', 'PHSC401', 'PHSC402', 'BSCI170', 'BSCI223', 'EPIB315', 'PHSC450', 'PHSC420', 'MIEH300', 'HLTH391', 'BSCI171', 'CHEM131', 'CHEM132', 'MATH130', 'STAT100'],
      goal: 'PHSC450',
      minRealCourses: 21,
    },
    {
      id: 'NFSC',
      required: ['NFSC100', 'NFSC112', 'NFSC315', 'NFSC341', 'NFSC421', 'NFSC430', 'NFSC440', 'NFSC450', 'NFSC455', 'NFSC470', 'BSCI170', 'BSCI171', 'BSCI222', 'CHEM131', 'CHEM132', 'CHEM231', 'CHEM232', 'CHEM271', 'CHEM272'],
      goal: 'NFSC450',
      minRealCourses: 23,
    },
    {
      id: 'HLTH',
      required: ['HLTH140', 'HLTH200', 'HLTH230', 'HLTH285', 'HLTH377', 'HLTH471', 'HLTH476', 'HLTH498L', 'HLTH490', 'HLTH302', 'HLTH410', 'HLTH460', 'PSYC100', 'BSCI170', 'STAT100'],
      goal: 'HLTH490',
      minRealCourses: 19,
    },
    {
      id: 'ENST',
      required: ['ENST200', 'ENST233', 'ENST301', 'ENST303', 'ENST388', 'ENST471', 'ENST499', 'ENST405', 'ENST422', 'ENST453', 'BSCI170', 'BSCI171', 'CHEM131', 'CHEM132', 'MATH130', 'STAT100', 'GEOL100'],
      goal: 'ENST499',
      minRealCourses: 21,
    },
    {
      id: 'ENCH',
      required: ['ENES100', 'CHBE101', 'CHBE250', 'CHBE301', 'CHBE302', 'CHBE333', 'CHBE410', 'CHBE422', 'CHBE424', 'CHBE426', 'CHBE437', 'CHBE440', 'CHBE442', 'CHBE444', 'CHBE446', 'CHBE457', 'CHBE482', 'CHBE490', 'BIOE120', 'MATH140', 'MATH141', 'MATH241', 'MATH246', 'PHYS161', 'PHYS270', 'PHYS271', 'CHEM135', 'CHEM136', 'CHEM231', 'CHEM232', 'CHEM241', 'CHEM242', 'CHEM272'],
      goal: 'CHBE446',
      minRealCourses: 36,
    },
    {
      id: 'ANSC',
      required: ['ANSC101', 'ANSC103', 'ANSC201', 'ANSC314', 'ANSC315', 'ANSC327', 'ANSC401', 'ANSC446', 'ANSC447', 'ANSC359', 'ANSC250', 'ANSC260', 'ANSC282', 'ANSC410', 'ANSC417', 'ANSC453', 'BSCI160', 'BSCI161', 'BSCI170', 'BSCI171', 'BSCI223', 'CHEM131', 'CHEM132', 'CHEM231', 'AREC250', 'AREC306', 'BIOM301', 'MATH113', 'STAT100'],
      goal: 'ANSC453',
      minRealCourses: 30,
    },
    {
      id: 'AREC',
      required: ['ECON200', 'ECON201', 'AREC326', 'AREC380', 'AREC422', 'AREC453', 'AREC456', 'AREC481', 'MATH120', 'STAT100', 'BMGT230', 'GEOG201', 'GVPT273', 'ENST415', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'AREC481',
      minRealCourses: 18,
    },
    {
      id: 'PLSC',
      required: ['PLSC110', 'PLSC111', 'ENST200', 'PLSC201', 'PLSC205', 'PLSC389', 'PLSC401', 'PLSC402', 'PLSC420', 'PLSC453', 'BSCI160', 'BSCI161', 'BSCI170', 'BSCI171', 'BSCI337', 'AGST275', 'PHYS121', 'INAG215', 'INAG235', 'MATH115', 'STAT100'],
      goal: 'PLSC402',
      minRealCourses: 25,
    },
    {
      id: 'ENMA',
      required: ['ENES100', 'ENES200', 'ENMA165', 'ENMA180', 'ENMA300', 'ENMA301', 'ENMA312', 'ENMA441', 'ENMA460', 'ENMA461', 'ENMA465', 'ENMA470', 'ENMA471', 'ENMA487', 'ENMA490', 'ENMA425', 'ENMA430', 'ENMA482', 'CHEM135', 'CHEM136', 'CHEM231', 'CHEM232', 'CHEM481', 'MATH140', 'MATH141', 'MATH241', 'MATH246', 'PHYS161', 'PHYS260', 'PHYS261', 'PHYS270', 'PHYS271'],
      goal: 'ENMA490',
      minRealCourses: 35,
    },
    {
      id: 'ENFP',
      required: ['ENFP201', 'ENFP250', 'ENFP300', 'ENFP310', 'ENFP312', 'ENFP350', 'ENFP405', 'ENFP410', 'ENFP411', 'ENFP413', 'ENFP415', 'ENFP420', 'ENFP425', 'ENFP426', 'ENFP440', 'STAT400', 'ENFP461', 'ENFP489I', 'ENME400', 'CHEM135', 'MATH140', 'MATH141', 'MATH241', 'MATH246', 'PHYS161', 'PHYS260', 'PHYS261', 'ENES100', 'ENES102', 'ENES220', 'ENES221', 'ENES232'],
      goal: 'ENFP440',
      minRealCourses: 35,
    },
    {
    ...
    {
      id: 'MATH',
      required: ['MATH140', 'MATH141', 'MATH240', 'MATH241', 'MATH246', 'MATH310', 'MATH403', 'MATH405', 'MATH410', 'MATH411', 'MATH430', 'MATH452', 'MATH456', 'STAT410', 'CMSC131', 'CMSC132', 'CMSC216', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'MATH411',
      minRealCourses: 20,
    },
    {
      id: 'STAT',
      required: ['MATH140', 'MATH141', 'MATH240', 'MATH241', 'MATH246', 'MATH310', 'MATH405', 'MATH410', 'STAT400', 'STAT401', 'STAT410', 'STAT420', 'STAT426', 'STAT430', 'STAT440', 'AMSC460', 'CMSC131', 'CMSC132', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'STAT420',
      minRealCourses: 21,
    },
    {
      id: 'CHEM',
      required: ['CHEM146', 'CHEM177', 'CHEM237', 'CHEM247', 'CHEM276', 'CHEM277', 'CHEM395', 'CHEM425', 'CHEM481', 'CHEM483', 'CHEM401', 'CHEM482', 'CHEM484', 'CHEM441', 'BCHM461', 'BSCI170', 'BSCI171', 'MATH140', 'MATH141', 'MATH241', 'PHYS161', 'PHYS260', 'PHYS261', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'CHEM441',
      minRealCourses: 26,
    },
    {
      id: 'PHYS',
      required: ['PHYS170', 'PHYS171', 'PHYS265', 'PHYS272', 'PHYS273', 'PHYS275', 'PHYS276', 'PHYS313', 'PHYS371', 'PHYS375', 'PHYS401', 'PHYS402', 'PHYS404', 'PHYS405', 'PHYS410', 'PHYS413', 'PHYS420', 'PHYS441', 'MATH140', 'MATH141', 'MATH241', 'MATH243', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'PHYS402',
      minRealCourses: 25,
    },
    {
      id: 'ASTR',
      required: ['ASTR130', 'ASTR131', 'ASTR232', 'ASTR310', 'ASTR320', 'ASTR406', 'ASTR415', 'ASTR421', 'ASTR450', 'ASTR498N', 'PHYS171', 'PHYS265', 'PHYS272', 'PHYS273', 'PHYS275', 'PHYS276', 'PHYS313', 'PHYS371', 'PHYS401', 'PHYS410', 'MATH140', 'MATH141', 'MATH241', 'MATH243', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'ASTR498N',
      minRealCourses: 27,
    },
    {
      id: 'AOSC',
      required: ['AOSC200', 'AOSC201', 'AOSC358L', 'AOSC431', 'AOSC432', 'AOSC493', 'AOSC494', 'AOSC498', 'AOSC400', 'AOSC401', 'AOSC424', 'AOSC433', 'AOSC445', 'AOSC470', 'CHEM135', 'CHEM136', 'MATH140', 'MATH141', 'MATH241', 'MATH246', 'PHYS161', 'PHYS174', 'PHYS260', 'PHYS261', 'PHYS270', 'PHYS271', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'AOSC498',
      minRealCourses: 29,
    },
    {
      id: 'BCHM',
      required: ['CHEM146', 'CHEM177', 'CHEM237', 'CHEM247', 'CHEM276', 'CHEM277', 'CHEM395', 'CHEM425', 'CHEM481', 'CHEM483', 'BCHM461', 'BCHM462', 'BCHM464', 'BCHM465', 'BCHM485', 'BSCI170', 'BSCI171', 'BSCI222', 'BSCI410', 'MATH140', 'MATH141', 'MATH241', 'PHYS161', 'PHYS260', 'PHYS261', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'BCHM465',
      minRealCourses: 28,
    },
    {
      id: 'NEUR',
      required: ['NEUR200', 'NEUR305', 'NEUR306', 'NEUR405', 'MATH135', 'MATH136', 'STAT400', 'BSCI160', 'BSCI161', 'BSCI170', 'BSCI171', 'CHEM131', 'CHEM132', 'CHEM231', 'CHEM232', 'CHEM241', 'CHEM242', 'CHEM271', 'CHEM272', 'PHYS131', 'PHYS132', 'PSYC100', 'BCHM461', 'BSCI222', 'BSCI331', 'BSCI332', 'BSCI410', 'BSCI440', 'NEUR479', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'NEUR479',
      minRealCourses: 31,
    },
    {
      id: 'GEOL',
      required: ['GEOL100', 'GEOL110', 'GEOL102', 'GEOL322', 'GEOL341', 'GEOL342', 'GEOL423', 'GEOL443', 'GEOL393', 'GEOL394', 'GEOL490', 'GEOL351', 'GEOL340', 'GEOL446', 'GEOL444', 'GEOL331', 'GEOL412', 'CHEM131', 'CHEM132', 'MATH140', 'MATH141', 'PHYS161', 'PHYS261', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'GEOL490',
      minRealCourses: 26,
    },
    {
    ...
    {
      id: 'EDUC',
      required: ['MATH212', 'MATH213', 'MATH214', 'TLPL251', 'HIST200', 'GEOG100', 'TLPL340', 'SOCY230', 'TLPL250', 'EDHD411', 'EDSP401', 'TLPL332', 'TLPL341', 'TLPL342', 'TLPL361', 'TLPL362', 'TLPL478B', 'TLPL479B', 'TLPL300', 'TLPL312', 'TLPL321', 'TLPL343', 'TLPL344', 'TLPL446', 'TLPL478C', 'TLPL489A', 'TLPL478D', 'TLPL489B', 'BSCI170', 'BSCI171', 'PHYS121', 'ENGL101', 'ENGL393', 'COMM107'],
      goal: 'TLPL489A',
      minRealCourses: 34,
    },
    {
      id: 'FINANCE',
      required: ['BMGT110', 'ECON200', 'MATH220', 'ENGL101', 'COMM107', 'ECON201', 'BMGT230', 'BMGT220', 'BMGT221', 'BMGT301', 'ENGL393', 'BMGT340', 'BMGT350', 'BMGT364', 'BMGT367', 'BMGT380', 'BMGT343', 'BMGT440', 'BMGT347', 'BMGT441', 'BMGT443', 'BMGT446', 'BMGT332', 'BMGT341', 'BMGT445', 'BMGT495'],
      goal: 'BMGT495',
      minRealCourses: 27,
    },
    {
      id: 'ACCOUNTING',
      required: ['BMGT110', 'ECON200', 'MATH220', 'ENGL101', 'COMM107', 'ECON201', 'BMGT230', 'BMGT220', 'BMGT221', 'BMGT301', 'ENGL393', 'BMGT340', 'BMGT350', 'BMGT364', 'BMGT367', 'BMGT380', 'BMGT310', 'BMGT321', 'BMGT326', 'BMGT311', 'BMGT323', 'BMGT411', 'BMGT422', 'BMGT417', 'BMGT495'],
      goal: 'BMGT417',
      minRealCourses: 26,
    },
    {
      id: 'IS',
      required: ['BMGT110', 'ECON200', 'MATH220', 'ENGL101', 'COMM107', 'ECON201', 'BMGT230', 'BMGT220', 'BMGT221', 'BMGT301', 'ENGL393', 'BMGT340', 'BMGT350', 'BMGT364', 'BMGT367', 'BMGT380', 'BMGT302', 'BMGT402', 'BMGT403', 'BMGT407', 'BMGT400', 'BMGT401', 'BMGT430', 'BMGT485', 'BMGT495'],
      goal: 'BMGT495',
      minRealCourses: 26,
    },
    {
      id: 'MARKETING',
      required: ['BMGT110', 'ECON200', 'MATH220', 'ENGL101', 'COMM107', 'ECON201', 'BMGT230', 'BMGT220', 'BMGT221', 'BMGT301', 'ENGL393', 'BMGT340', 'BMGT350', 'BMGT364', 'BMGT367', 'BMGT380', 'BMGT354', 'BMGT351', 'BMGT457', 'BMGT456', 'BMGT453', 'BMGT450', 'BMGT454', 'BMGT455', 'BMGT495'],
      goal: 'BMGT495',
      minRealCourses: 26,
    },
    {
      id: 'MGMT',
      required: ['BMGT110', 'ECON200', 'MATH220', 'ENGL101', 'COMM107', 'ECON201', 'BMGT230', 'BMGT220', 'BMGT221', 'BMGT301', 'ENGL393', 'BMGT340', 'BMGT350', 'BMGT364', 'BMGT367', 'BMGT380', 'BMGT363', 'BMGT362', 'BMGT360', 'BMGT366', 'BMGT461', 'BMGT463', 'BMGT466', 'BMGT495'],
      goal: 'BMGT495',
      minRealCourses: 25,
    },
    {
      id: 'SCM',
      required: ['BMGT110', 'ECON200', 'MATH220', 'ENGL101', 'COMM107', 'ECON201', 'BMGT230', 'BMGT220', 'BMGT221', 'BMGT301', 'ENGL393', 'BMGT340', 'BMGT350', 'BMGT364', 'BMGT367', 'BMGT380', 'BMGT370', 'BMGT372', 'BMGT472', 'BMGT476', 'BMGT477', 'BMGT385', 'BMGT475', 'BMGT495'],
      goal: 'BMGT475',
      minRealCourses: 25,
    },
  ];
...
async function testAutoPlanDiagnostics(context) {
  const result = clone(await vm.runInContext(`
    (async () => {
      ...
      const originalAoscSchedule = MAJOR_TEMPLATES.AOSC.fixedSchedule;
      MAJOR_TEMPLATES.AOSC.fixedSchedule = null;
      const template = await buildAutoPlanPreview('AOSC', {
        noFetch: true,
        force: true,
        profilePrefs: getProfilePrefs()
      });
      ...
      const mixed = await buildAutoPlanPreview('AOSC', {
        force: true,
        profilePrefs: getProfilePrefs()
      });
      ...
      const builtInSourceMissing = listMajors()
        ...
        .map(major => major.id);
      MAJOR_TEMPLATES.AOSC.fixedSchedule = originalAoscSchedule;
  ...
  assert(/Elective Roadmap/.test(result.templateHtml) && /profile\/elective slot/.test(result.templateHtml), 'auto plan elective roadmap: review should render roadmap summary');
  assert(/Find profile fits/.test(result.templateHtml), 'auto plan elective roadmap: should show Browse actions for profile elective rows');
  ...
  assert(/Requirement source/.test(result.templateHtml) && /Atmospheric/.test(result.templateHtml), 'auto plan diagnostics: source samples should include selected official requirement source');
  ...
  assert(result.templateFreshnessSummary.generatedCount === 1, 'auto plan diagnostics: freshness report should count the synthetic generated template');
  assert(result.templateFreshnessSummary.requirementRows === result.templateCoverage.total, 'auto plan diagnostics: freshness report should count synthetic generated requirement rows');
  ...
  assert(/0\/1/.test(result.templateFreshnessHtml), 'auto plan diagnostics: freshness report should show the synthetic generated catalog audit count');
  assert(/PlanetTerp/.test(result.templateFreshnessHtml), 'auto plan diagnostics: freshness report should name the live source');
  assert(/pass208-curated-final-all/.test(result.templateFreshnessHtml), 'auto plan diagnostics: freshness report should show the audit seed');
  ...
  assert(/Catalog year 2026-2027/.test(result.templateFreshnessHtml) && /checked July 7, 2026/.test(result.templateFreshnessHtml), 'auto plan diagnostics: freshness report should show source year metadata');
  ...
  assert(result.templateOfficialSources.some(link => /Atmospheric/.test(link.label) && /academiccatalog\.umd\.edu/.test(link.url)), 'auto plan diagnostics: preview should carry selected official catalog source');
  assert(result.templateOfficialSources.some(link => link.year === '2026-2027' && link.checkedAt === 'July 7, 2026'), 'auto plan diagnostics: preview should carry official source year metadata');
      ...
      try {
        ...
        applyMajorTemplate = async (id, opts) => {
          ...
          state.settings = normalizeSettings({
            ...
            eyebrow: 'UMD · Atmospheric & Oceanic Science',
            totalCredits: 120,
...
async function testCatalogYearTargeting(context) {
  const result = clone(await vm.runInContext(`
    (async () => {
      ...
      const preview = await buildAutoPlanPreview('AOSC', {
        noFetch: true,
        force: true,
  ...
  assert(/Curated fixed-schedule sweep/.test(result.releaseHtml), 'catalog year: release checklist should show curated fixed-schedule sweep evidence');
  assert(/61\/61 curated majors/.test(result.releaseHtml), 'catalog year: release checklist should show every curated major has a source page');
  assert(/826\/826 unique curated courses/.test(result.releaseHtml), 'catalog year: release checklist should show strict curated live course coverage');
  assert(/0 unexpected credit warnings/.test(result.releaseHtml) && /13 acknowledged PlanetTerp credit lags/.test(result.releaseHtml), 'catalog year: release checklist should explain curated credit-source drift');
  assert(/Generated course catalog sweep/.test(result.releaseHtml) && /0\/0 unique generated required courses/.test(result.releaseHtml), 'catalog year: release checklist should show generated course catalog sweep evidence');
  assert(/0\/0 title drifts/.test(result.releaseHtml) && /official UMD catalog/.test(result.releaseHtml), 'catalog year: release checklist should show official title drift evidence');
...
function testCanonicalCourseTitles(context) {
  const result = clone(vm.runInContext(`
    ({
      ...
      bmgt301: UMDIO_CANONICAL_TITLES.BMGT301,
  ...
  assert(result.bmgt301 === 'Information Systems, AI, and Digital Transformation', 'canonical titles: BMGT 301 should use the current live catalog title');
