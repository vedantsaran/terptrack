...
async function runViewport(browser, url, viewport, selected, opts) {
  ...
  try {
    ...
    assert(initialSnapshot.scripts.includes('js/settings.js?v=53'), `${viewport.label}: rendered app did not load js/settings.js?v=53`);
    ...
    assert(initialSnapshot.releaseText.includes('Pass 218'), `${viewport.label}: release checklist missing Pass 218 snapshot`);
