...
async function openFreshApp(page, url, opts, suffix) {
  ...
  assert(snapshot.scripts.includes('js/dnd.js?v=1'), 'workflow app did not load js/dnd.js?v=1');
  assert(snapshot.scripts.includes('js/state.js?v=19'), 'workflow app did not load js/state.js?v=19');
