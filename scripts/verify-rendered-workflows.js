...
async function openFreshApp(page, url, opts, suffix) {
  ...
  assert(snapshot.scripts.includes('js/schedule.js?v=69'), 'workflow app did not load js/schedule.js?v=69');
  ...
  assert(snapshot.scripts.includes('js/share.js?v=13'), 'workflow app did not load js/share.js?v=13');
