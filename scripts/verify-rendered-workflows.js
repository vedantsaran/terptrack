...
async function openFreshApp(page, url, opts, suffix) {
  ...
  assert(snapshot.scripts.includes('js/browse.js?v=18'), 'workflow app did not load js/browse.js?v=18');
  ...
  assert(snapshot.scripts.includes('js/placeholder-search.js?v=11'), 'workflow app did not load js/placeholder-search.js?v=11');
